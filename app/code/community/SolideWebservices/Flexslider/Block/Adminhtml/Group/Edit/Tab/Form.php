...
class SolideWebservices_Flexslider_Block_Adminhtml_Group_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
	...
	protected function _prepareForm() {
		...
		$overlay_textcolor = $fieldset->addField('overlay_textcolor', 'text', array(
			...
			'class'		=> 'colorpicker',
			'value'		=> $this->returnOverlayTextcolor()
		));
		...
		$overlay_bgcolor = $fieldset->addField('overlay_bgcolor', 'text', array(
			...
			'class'		=> 'colorpicker',
			'value'		=> $this->returnOverlayBgcolor()
		));
		...
		$overlay_hovercolor = $fieldset->addField('overlay_hovercolor', 'text', array(
			...
			'class'		=> 'colorpicker',
			'value'		=> $this->returnOverlayHovercolor()
		));
		...
		$pagination_color = $fieldset->addField('pagination_color', 'text', array(
			...
			'class'		=> 'colorpicker',
			'value'		=> $this->returnPaginationColor()
		));
		...
		$loader_bgcolor = $fieldset->addField('loader_bgcolor', 'text', array(
			...
			'class'		=> 'colorpicker',
			'value'		=> $this->returnLoaderBgcolor()
		));
		...
		$caption_textcolor = $fieldset->addField('caption_textcolor', 'text', array(
			...
			'class'		=> 'colorpicker',
			'value'		=> $this->returnCaptionTextcolor()
		));
		...
		$caption_bgcolor = $fieldset->addField('caption_bgcolor', 'text', array(
			...
			'class'		=> 'colorpicker',
			'value'		=> $this->returnCaptionBgcolor(),
			'after_element_html'	=> '<script type="text/javascript">
	...
	public function returnPaginationColor() {
		$_model = Mage::registry('group_data');
		if($_model->getPaginationColor()) { return $_model->getPaginationColor(); } else { return '#ffffff'; }
	}
	
	public function returnLoaderColor() {
		$_model = Mage::registry('group_data');
		if($_model->getLoaderColor()) { return $_model->getLoaderColor(); } else { return '#eeeeee'; }
	}

	public function returnLoaderBgcolor() {
		$_model = Mage::registry('group_data');
		if($_model->getLoaderBgcolor()) { return $_model->getLoaderBgcolor(); } else { return '#222222'; }
	}
	...
	public function returnCaptionTextcolor() {
		$_model = Mage::registry('group_data');
		if($_model->getCaptionTextcolor()) { return $_model->getCaptionTextcolor(); } else { return '#ffffff'; }
	}

	public function returnCaptionBgcolor() {
		$_model = Mage::registry('group_data');
		if($_model->getCaptionBgcolor()) { return $_model->getCaptionBgcolor(); } else { return '#222222'; }
	}
	...
	public function returnOverlayTextcolor() {
		$_model = Mage::registry('group_data');
		if($_model->getOverlayTextcolor()) { return $_model->getOverlayTextcolor(); } else { return '#ffffff'; }
	}

	public function returnOverlayBgcolor() {
		$_model = Mage::registry('group_data');
		if($_model->getOverlayBgcolor()) { return $_model->getOverlayBgcolor(); } else { return '#222222'; }
	}

	public function returnOverlayHovercolor() {
		$_model = Mage::registry('group_data');
		if($_model->getOverlayHovercolor()) { return $_model->getOverlayHovercolor(); } else { return '#666666'; }
	}
