 ...
 * Last Modified: 2013-09-08T17:03:21+02:00
...
class Xtento_StockImport_Block_Adminhtml_Log_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    ...
    {
        $formMessages = array();
        $formMessages[] = array('type' => 'notice', 'message' => Mage::helper('xtento_stockimport')->__('Any imports get logged here. Find failed imports or download imported files.'));
        return $formMessages;
    }
