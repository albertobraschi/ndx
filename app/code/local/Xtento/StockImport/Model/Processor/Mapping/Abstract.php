 ...
 * Last Modified: 2013-09-08T16:42:12+02:00
...
abstract class Xtento_StockImport_Model_Processor_Mapping_Abstract extends Varien_Object
{
    ...
    public function getDefaultValues($entity)
    {
        ...
        if ($entity == 'stock_status') {
            $defaultValues[0] = Mage::helper('xtento_stockimport')->__('In Stock');
            $defaultValues[1] = Mage::helper('xtento_stockimport')->__('Out Of Stock');
        }
        if ($entity == 'yesno') {
